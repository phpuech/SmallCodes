...
datasave = outputpath+"compilation-"+maintenant +'.txt'
...
files = [f for f in os.listdir(inputpath) if f.endswith('-data.txt')]
...
for fichier in files:
    ...
    df = pd.read_csv(localfichier, delimiter=r"\s+", names=['0', 'E','2', '3','4', '5'], skiprows=9)
    print df['E']    
